...
public class LyThuyet extends SGK{
    ...
    public LyThuyet(String maSach, String tenSach, int lop, int namXuatBan,  String nhaXuatBan, int soLuong, double giaSach, Date ngayNhap) {
    ...
    public String toString() {
        ...
        return "Sach LT {" + "Ma sach: " + maSach + ", Ten sach: " + tenSach + ", Lop: " + lop + ", Nam xuat ban: " + namXuatBan + ", Nha xuat ban: " + nhaXuatBan + ", So luong: " + soLuong + ", Gia sach: " + giaSach + ", Ngay nhap: " + ngayNhapLT + '}';
    }
    @Override
