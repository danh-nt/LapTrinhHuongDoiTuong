...
public class BaiTap extends SGK {
    ...
    public String toString() {
        ...
        return "Sach BT {" + "Ma sach: " + maSach + ", Ten sach: " + tenSach + ", Lop: " + lop + ", Nam xuat ban: " + namXuatBan + ", Nha xuat ban: " + nhaXuatBan + ", So luong: " + soLuong + ", Gia sach: " + giaSach + ", Ngay nhap: " + ngayNhapLT + '}';
    }
